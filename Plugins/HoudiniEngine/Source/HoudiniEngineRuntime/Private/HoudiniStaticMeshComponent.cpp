...
UHoudiniStaticMeshComponent::UHoudiniStaticMeshComponent(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    ...
    (*gen->ContainerPtrToValuePtr<FName>(&(*this).BodyInstance, 0)) = TEXT("NoCollision");
    ...
    (*gen3->ContainerPtrToValuePtr<FCollisionResponseContainer>(&(*gen2->ContainerPtrToValuePtr<FCollisionResponse>(&(*this).BodyInstance, 0)), 0)).GameTraceChannel1 = ECR_Ignore;
    ...
    (*gen3->ContainerPtrToValuePtr<FCollisionResponseContainer>(&(*gen2->ContainerPtrToValuePtr<FCollisionResponse>(&(*this).BodyInstance, 0)), 0)).GameTraceChannel15 = ECR_Ignore;
