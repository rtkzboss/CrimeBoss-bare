#include "IGS_SetMenuFadeTransitionStateLatent.h"

UIGS_SetMenuFadeTransitionStateLatent::UIGS_SetMenuFadeTransitionStateLatent() {
}

void UIGS_SetMenuFadeTransitionStateLatent::TransitionFinished_Internal() {
}
