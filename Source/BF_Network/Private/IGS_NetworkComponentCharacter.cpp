...
UIGS_NetworkComponentCharacter::UIGS_NetworkComponentCharacter(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    ...
    (*this).mR_AvailableWieldables = TArray<FIGS_WieldableReplicatedData>{gen, gen2, FIGS_WieldableReplicatedData{}, gen3, gen4, gen5};
    (*this).m_OwningInventoryObjects = TArray<UIGS_InventoryObjectFramework*>{nullptr, nullptr, nullptr, nullptr, nullptr, nullptr};
