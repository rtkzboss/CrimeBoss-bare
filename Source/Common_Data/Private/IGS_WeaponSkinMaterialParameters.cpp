...
FIGS_WeaponSkinMaterialParameters::FIGS_WeaponSkinMaterialParameters() {
    (*this).Albedo_Tint = FLinearColor(1.000000000e+00f, 1.000000000e+00f, 1.000000000e+00f, 1.000000000e+00f);
    ...
    (*this).Dust_Albedo = FLinearColor(4.313699901e-02f, 3.529400006e-02f, 1.568599977e-02f, 1.000000000e+00f);
    ...
    (*this).Scratches_Albedo = FLinearColor(3.137300164e-02f, 3.529400006e-02f, 5.098000169e-02f, 1.000000000e+00f);
