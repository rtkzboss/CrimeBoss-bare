...
FIGS_ShootablePart::FIGS_ShootablePart() {
    ...
    auto gen = TBaseStructure<FDataRegistryType>::Get()->FindPropertyByName("Name");
    (*gen->ContainerPtrToValuePtr<FName>(&(*this).ReducesDamage.RegistryType, 0)) = NAME_None;
    ...
    (*gen->ContainerPtrToValuePtr<FName>(&(*this).DamagePenetration.RegistryType, 0)) = NAME_None;
    ...
    (*gen->ContainerPtrToValuePtr<FName>(&(*this).ChanceToShootOff.RegistryType, 0)) = NAME_None;
}
