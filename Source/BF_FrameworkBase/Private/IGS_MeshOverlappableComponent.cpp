...
UIGS_MeshOverlappableComponent::UIGS_MeshOverlappableComponent(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    ...
    (*gen3->ContainerPtrToValuePtr<FCollisionResponseContainer>(&(*gen2->ContainerPtrToValuePtr<FCollisionResponse>(&(*this).BodyInstance, 0)), 0)).GameTraceChannel1 = ECR_Overlap;
