...
UIGS_GlobalGASComponent::UIGS_GlobalGASComponent(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    static ConstructorHelpers::FObjectFinder<UIGS_GASDefaultAttributesDataAsset> gen(TEXT("/Game/00_Main/GameplayAbilitySystem/Attributes/DA_DefaultGlobalAttributes.DA_DefaultGlobalAttributes"));
