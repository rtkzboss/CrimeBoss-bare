...
FIGS_SaveData_Account::FIGS_SaveData_Account() {
    ...
    (*this).NewsInfoSaveData.PatchNotesVersionsSeen = {};
    (*this).UnlockedCharactersAccWide = {};
    (*this).HiredCharactersInLastCampaign = {};
    (*this).UnlockedUniqueCharactersLevel = {};
    (*this).CharacterPlotlineProgress = {};
    (*this).TimePlayed = 0.000000000e+00f;
    auto gen = TBaseStructure<FGameplayTag>::Get()->FindPropertyByName("TagName");
    (*gen->ContainerPtrToValuePtr<FName>(&(*this).QuickPlayPreferences.PlayerHeisterData.TagID, 0)) = NAME_None;
    ...
    (*gen2->ContainerPtrToValuePtr<TArray<uint8>>(&(*this).QuickPlayPreferences.PlayerHeisterData.UniquePlayerId, 0)) = {};
    (*this).QuickPlayPreferences.PlayerHeisterData.Loadout.PrimaryWeapon = nullptr;
    (*gen->ContainerPtrToValuePtr<FName>(&(*this).QuickPlayPreferences.PlayerHeisterData.Loadout.PrimaryWeaponSkin, 0)) = NAME_None;
    (*this).QuickPlayPreferences.PlayerHeisterData.Loadout.SecondaryWeapon = nullptr;
    (*gen->ContainerPtrToValuePtr<FName>(&(*this).QuickPlayPreferences.PlayerHeisterData.Loadout.SecondaryWeaponSkin, 0)) = NAME_None;
    (*this).QuickPlayPreferences.PlayerHeisterData.Loadout.Equipment = {};
    (*this).QuickPlayPreferences.PlayerHeisterData.Loadout.Perks = {};
    (*this).QuickPlayPreferences.PlayerHeisterData.Loadout.Ability1ChargesLeft = -1;
    (*gen->ContainerPtrToValuePtr<FName>(&(*this).QuickPlayPreferences.PlayerHeisterData.Loadout.CharacterSkinID, 0)) = NAME_None;
    ...
    (*this).MetaPersistentData = {};
    (*this).PendingUnlockRewards = {};
    ...
    (*this).BossLevelData.BonusesLvls = {};
    (*this).BossLevelData.PreparedBonuses = {};
    (*this).BossLevelData.RemainingLvlUps = 0;
    (*this).BossLevelData.LastSeenLvlUpScreen = 1;
    (*this).Statistic.Singleplayer = {};
    (*this).CityMapData.LastPlayerTileGroupIndex = 0;
    (*this).CityMapData.LastPlayerInitialTileGroup = {};
    auto gen3 = TBaseStructure<FGameplayTagContainer>::Get()->FindPropertyByName("GameplayTags");
    (*gen3->ContainerPtrToValuePtr<TArray<FGameplayTag>>(&(*this).MetaPersistentAssetData, 0)) = {};
    auto gen4 = TBaseStructure<FGameplayTagContainer>::Get()->FindPropertyByName("ParentTags");
    (*gen4->ContainerPtrToValuePtr<TArray<FGameplayTag>>(&(*this).MetaPersistentAssetData, 0)) = {};
    (*gen3->ContainerPtrToValuePtr<TArray<FGameplayTag>>(&(*this).MetaMenuActiveTags, 0)) = {};
    (*gen4->ContainerPtrToValuePtr<TArray<FGameplayTag>>(&(*this).MetaMenuActiveTags, 0)) = {};
    ...
    (*gen3->ContainerPtrToValuePtr<TArray<FGameplayTag>>(&(*this).CompletedTutorialTags, 0)) = {};
    (*gen4->ContainerPtrToValuePtr<TArray<FGameplayTag>>(&(*this).CompletedTutorialTags, 0)) = {};
    ...
    (*gen->ContainerPtrToValuePtr<FName>(&(*this).ActiveCampaign.CampaignMode, 0)) = NAME_None;
    (*this).ActiveCampaign.Difficulty = EIGS_UserDifficulty::UD_Unknown;
    (*this).UnlockedItemIDs = {};
    (*this).PendingUnlockedItemIDs = {};
    ...
    (*this).Progression.PendingUnlockedItems = {};
    (*this).Progression.UnlockedRewardsHistory = {};
    (*this).Challenges.ChallengesInProgress = {};
    (*this).Challenges.CompletedChallenges = {};
    (*this).CompletedCampaignCounts = {};
}
