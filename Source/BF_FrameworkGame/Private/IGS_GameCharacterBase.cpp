...
AIGS_GameCharacterBase::AIGS_GameCharacterBase(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    ...
    static ConstructorHelpers::FClassFinder<UIGS_ImpactTypeObject> gen0(TEXT("/Game/00_Main/Core/Tables/Impacts/Shot/ID/BP_ImpactShot_KillConfirmed.BP_ImpactShot_KillConfirmed_C"));
    (*this).KillConfirmedParticleID = gen0.Class;
