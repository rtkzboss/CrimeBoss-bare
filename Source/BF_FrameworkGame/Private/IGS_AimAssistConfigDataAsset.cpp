...
UIGS_AimAssistConfigDataAsset::UIGS_AimAssistConfigDataAsset() {
    ...
    (*this).SlowdownConfig.SlowdownStrengthCurve.EditorCurveData.Keys = TArray<FRichCurveKey>{gen, gen2};
    ...
    (*this).SlowdownConfig.ZonesScalingConfig.ZonesScalingCurve.EditorCurveData.Keys = TArray<FRichCurveKey>{gen3, gen4};
    ...
    (*this).SoftLockConfig.ZonesScalingConfig.ZonesScalingCurve.EditorCurveData.Keys = TArray<FRichCurveKey>{gen5, gen6};
    ...
    (*this).BulletBendingConfig.InterpolationCurve.EditorCurveData.Keys = TArray<FRichCurveKey>{FRichCurveKey{}, gen7};
    ...
    (*this).BulletBendingConfig.ZonesScalingConfig.ZonesScalingCurve.EditorCurveData.Keys = TArray<FRichCurveKey>{gen8, gen9};
