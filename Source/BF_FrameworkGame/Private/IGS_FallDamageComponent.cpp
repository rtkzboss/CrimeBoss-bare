...
UIGS_FallDamageComponent::UIGS_FallDamageComponent(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    ...
    static ConstructorHelpers::FObjectFinder<UCurveFloat> gen(TEXT("/Game/00_Main/Core/Tables/Curve_FallDamage_Float.Curve_FallDamage_Float"));
    (*this).FallDamageCurve = gen.Object;
    static ConstructorHelpers::FClassFinder<UIGS_DamageTypeFallDamage> gen2(TEXT("/Game/00_Main/Core/DamageTypes/BP_DT_FallDamage.BP_DT_FallDamage_C"));
    (*this).FallDamageType = gen2.Class;
}
