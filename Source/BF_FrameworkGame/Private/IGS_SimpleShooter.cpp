...
UIGS_SimpleShooter::UIGS_SimpleShooter(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    ...
    static ConstructorHelpers::FObjectFinder<UAkAudioEvent> gen3(TEXT("/Game/WwiseAudio/GeneratedSoundData/SoundBanks/Events/Default_Work_Unit/WU_Weapons/WU_Weapons_Ranged/AKE_WeaponFire_Single.AKE_WeaponFire_Single"));
    (*this).SingleShotAudioEvent = gen3.Object;
    ...
    static ConstructorHelpers::FObjectFinder<UAkRtpc> gen5(TEXT("/Game/WwiseAudio/GeneratedSoundData/SoundBanks/Game_Parameters/Default_Work_Unit/WU_Weapons/RTPC_WeaponFireRate.RTPC_WeaponFireRate"));
    (*this).FireRateAkRtpc = gen5.Object;
    static ConstructorHelpers::FObjectFinder<UAkRtpc> gen6(TEXT("/Game/WwiseAudio/GeneratedSoundData/SoundBanks/Game_Parameters/Default_Work_Unit/WU_Weapons/RTPC_WeaponRoundsLeft.RTPC_WeaponRoundsLeft"));
    (*this).RoundsLeftAkRtpc = gen6.Object;
    static ConstructorHelpers::FObjectFinder<UAkRtpc> gen7(TEXT("/Game/WwiseAudio/GeneratedSoundData/SoundBanks/Game_Parameters/Default_Work_Unit/WU_Weapons/RTPC_WeaponAimDownSight.RTPC_WeaponAimDownSight"));
