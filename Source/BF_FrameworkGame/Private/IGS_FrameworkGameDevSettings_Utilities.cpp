...
UIGS_FrameworkGameDevSettings_Utilities::UIGS_FrameworkGameDevSettings_Utilities() {
    (*this).UnderWaterClearMaterial = FSoftObjectPath();
    (*this).UnderWaterDeepBlueMaterial = FSoftObjectPath();
    (*this).UnderWaterLakeMaterial = FSoftObjectPath();
    (*this).UnderWaterLoopSound = FSoftObjectPath();
