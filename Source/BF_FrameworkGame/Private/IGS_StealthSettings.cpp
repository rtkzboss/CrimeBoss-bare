...
UIGS_StealthSettings::UIGS_StealthSettings() {
    ...
    (*this).DistanceDetectionSpeedCurve.EditorCurveData.Keys = TArray<FRichCurveKey>{gen, gen2, gen3};
    ...
    (*this).AngleDetectionSpeedCurve.EditorCurveData.Keys = TArray<FRichCurveKey>{gen4, gen5, gen6};
