...
FIGS_JoinedPlayers::FIGS_JoinedPlayers() {
    ...
    (*this).FirstPlayer.CachedHeisterData.TagID = FGameplayTag();
    ...
    (*this).SecondPlayer.CachedHeisterData.TagID = FGameplayTag();
    ...
    (*this).ThirdPlayer.CachedHeisterData.TagID = FGameplayTag();
    ...
    (*this).FourthPlayer.CachedHeisterData.TagID = FGameplayTag();
