...
UIGS_AIGrenadeManager::UIGS_AIGrenadeManager(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    ...
    (*this).UpThrowTag = FGameplayTag::RequestGameplayTag(TEXT("Anim.Combat.Throw.Frag.Up"));
    (*this).DownThrowTag = FGameplayTag::RequestGameplayTag(TEXT("Anim.Combat.Throw.Frag.Down"));
}
